const docTabs = () => {
    ...
    const tabs = () => {
        ...
        const showSlide = index => {
            ...
            const changeSlide = () => {
                popupTransparencySlider.forEach(slide => slide.style.transform = `translateY(-${count * slideWidth}px)`);
    ...
    const ifMobile = () => {
        ...
        const carousel = () => {
            transparencySlider.style.transform = `translateX(calc(-${count * widthSlide}px))`;
        };
